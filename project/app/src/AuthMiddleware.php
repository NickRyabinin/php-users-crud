...
/**
 * Класс AuthMiddleware - слой приложения между роутером и контроллерами,
 * проверяющий предоставленные пользователю разрешения для возможности
 * доступа к определённым ресурсам приложения
 */
